 ...
 */
	...
	'login:empty' => "Nom d'utilisateur/e-mail et mot de passe sont requis.",
 ...
 * Errors
 */
	'exception:title' => "Erreur bloquante.",
	'exception:contact_admin' => 'Une erreur bloquante s\'est produite et a été enregistrée. Veuillez svp contactez l\'administrateur du site avec l\'information suivante:',
	...
	'SecurityException:ForwardFailedToRedirect' => 'La redirection n\'a pas pu se faire à cause d\'entêtes de page qui ont déjà été envoyés. Pour des raisons de sécurité, le déroulement à été arrêté à cause de l\'opération dans le fichier %s à la ligne %d. Consultez http://docs.elgg.org/ pour plus d\'informations.',
	...
	'LoginException:UsernameFailure' => 'Nous n\'avons pas pu vous connecter! Vérifiez votre nom d\'utilisateur/e-mail et mot de passe.',
	'LoginException:PasswordFailure' => 'Nous n\'avons pas pu vous connecter. Vérifiez votre nom d\'utilisateur/e-mail et mot de passe.',
	...
	'noaccess' => 'Vous devez vous connecter pour voir ce contenu ou ce contenu a été supprimé ou vous n\'avez pas la permission de le consulter.',
 ...
 */
	...
	'registration:notemail' => 'L\'adresse e-mail que vous avez renseignée ne semble pas être valide.',
	...
	'user:resetpassword:reset_password_confirm' => 'Le processus de réinitialisation de votre mot de passe va vous envoyer un nouveau mot de passe à votre adresse e-mail.',
	...
	'user:password:text' => 'Pour générer un nouveau mot de passe, entrez votre e-mail ou nom d\'utilisateur ci-dessous. Puis cliquez sur le bouton de demande.',
 ...
 */
	...
	'admin:statistics:label:coopfunding_release' => "Version Coopfunding",
 ...
 */
	...
	'installation:siteemail' => "L'adresse e-mail du site (utilisée lors des envois d'e-mails par le système)",
...
Quelqu'un (depuis l'adresse IP %s) a demandé un nouveau mot de passe pour son compte.
...
Pour répondre ou voir le contenu d'origine, suivez ce lien:
 ...
 */
	...
	'actiongatekeeper:tokeninvalid' => "La page que vous utilisiez a expiré. Essayez de nouveau svp.",
	...
	'actiongatekeeper:crosssitelogin' => "Désolé, se connecter depuis un domaine différent n'est pas autorisé. Essayez de nouveau svp.",
 ...
 */
	...
	'js:security:token_refresh_failed' => 'Impossible de contacter %s. Vous pourriez rencontrer des difficultés pour enregistrer ce que vous faites. Veuillez svp actualiser la page.',
